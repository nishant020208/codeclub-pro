      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-scale-in">
        ...
        <div className="terminal-card rounded-lg p-7">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="button" onClick={() => signInWithGoogle().catch(e => toast.error(e.message))}
              className="w-full py-2.5 rounded-md bg-background border border-border text-foreground text-sm flex items-center justify-center gap-2 hover:bg-muted">
